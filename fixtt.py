...
The Company (wavegxz-design)  assumes no responsibility for errors or omissions in the contents of the Service
In no event shall the Company (wavegxz-design) be liable for any special, direct, indirect, consequential, or incidental damages or any damages whatsoever, whether in an action of contract, negligence or other tort, arising out of or in connection with the use of the Service or the contents of the Service. The Company reserves the right to make additions, deletions, or modifications to the contents on the Service at any time without prior notice.
...
def get_whois_info(ip):
    response = requests.get(f"https://whois.arin.net/rest/ip/{ip}.json", timeout=8)
    return response.json()
...
def run_command(command):
    ...
    FIX [SECURITY]: shell=True replaced with shlex.split() to prevent shell injection.
    """
    import shlex
    try:
...
def update_repo():
    # FIX [SECURITY]: Added user confirmation before destructive git reset --hard.
    # Prevents silent code replacement if upstream repo is compromised.
    print("\033[1;33m[!] Auto-update will overwrite local changes with origin/master.\033[0m")
    confirm = input("\033[1;97m[?] Confirm update? (yes/no): \033[0m").strip().lower()
    if confirm != 'yes':
        print("\033[1;34m[*] Update cancelled.\033[0m")
        return
    subprocess.run(['git', 'fetch', 'origin'], check=True)
    subprocess.run(['git', 'reset', '--hard', 'origin/master'], check=True)
    print("\033[1;32m[✔] Update complete.\033[0m")
...
def newsOsint():
    # FIX: API key from environment variable — never hardcode secrets
    api_key = os.environ.get('NEWSAPI_KEY', '').strip()
    if not api_key:
        print('\033[1;33m[!] NEWSAPI_KEY not set. Set with: export NEWSAPI_KEY="your_key"\033[0m')
        print('\033[2m    Get a free key at: https://newsapi.org/register\033[0m')
        return
...
# ── FIXTT INTERFACE v7.1 — krypthane ─────────────────────────────
G  = "\033[38;5;46m"
GD = "\033[38;5;34m"
R2 = "\033[38;5;196m"
CY = "\033[38;5;51m"
...
tookie_banner = ""  # deprecated — kept for compat
...
def print_banner():
    ...
    lines = [
        ...
        GD + "  │" + G  + "  ╚═╝     ╚═╝╚═╝  ╚═╝   ╚═╝      ╚═╝          " + GD + "│" + RS,
        GD + "  ├" + "─"*56 + "┤" + RS,
        GD + "  │" + DM + "    Advanced OSINT Intelligence Framework        " + GD + "│" + RS,
        GD + "  ├" + "─"*56 + "┤" + RS,
        ...
        GD + "  │" + WH + "  Version  : " + YL + "v2.3" + DM + "  ·  " + WH + "Platform: " + CY + platform.system() + " "*(max(0,16-len(platform.system()))) + GD + "  │" + RS,
        GD + "  │" + WH + "  Time     : " + YL + current_time + DM + "                                 " + GD + "│" + RS,
        GD + "  └" + "─"*56 + "┘" + RS,
        "",
    ]
    for line in lines:
...
main_menu = (
    "\033[38;5;34m  ┌─────────────────────────────────────────────┐\033[0m\n"
    "\033[38;5;34m  │\033[38;5;46m  [??] SELECT MODULE                         \033[38;5;34m│\033[0m\n"
    "\033[38;5;34m  ├─────────────────┬───────────────────────────┤\033[0m\n"
    "\033[38;5;34m  │\033[1;97m [\033[38;5;226m01\033[1;97m] IP Address     \033[38;5;34m│\033[1;97m [\033[38;5;226m11\033[1;97m] Metadata Extraction  \033[38;5;34m│\033[0m\n"
    "\033[38;5;34m  │\033[1;97m [\033[38;5;226m02\033[1;97m] Email Info     \033[38;5;34m│\033[1;97m [\033[38;5;226m12\033[1;97m] Twitter Status        \033[38;5;34m│\033[0m\n"
    "\033[38;5;34m  │\033[1;97m [\033[38;5;226m03\033[1;97m] Image Location \033[38;5;34m│\033[1;97m [\033[38;5;226m13\033[1;97m] Subdomain Enum        \033[38;5;34m│\033[0m\n"
    "\033[38;5;34m  │\033[1;97m [\033[38;5;226m04\033[1;97m] Host Search    \033[38;5;34m│\033[1;97m [\033[38;5;226m14\033[1;97m] Google Dork Hacking   \033[38;5;34m│\033[0m\n"
    "\033[38;5;34m  │\033[1;97m [\033[38;5;226m05\033[1;97m] Port Scanner   \033[38;5;34m│\033[1;97m [\033[38;5;226m15\033[1;97m] SMTP Analysis         \033[38;5;34m│\033[0m\n"
    "\033[38;5;34m  │\033[1;97m [\033[38;5;226m06\033[1;97m] Exploit CVE    \033[38;5;34m│\033[1;97m [\033[38;5;226m16\033[1;97m] InfoStealer Check     \033[38;5;34m│\033[0m\n"
    "\033[38;5;34m  │\033[1;97m [\033[38;5;226m07\033[1;97m] Exploit OSVD   \033[38;5;34m│\033[1;97m [\033[38;5;226m17\033[1;97m] Dark Web Search        \033[38;5;34m│\033[0m\n"
    "\033[38;5;34m  │\033[1;97m [\033[38;5;226m08\033[1;97m] DNS Lookup     \033[38;5;34m│\033[1;97m [\033[38;5;226m18\033[1;97m] Next Tools  \033[38;5;208m>\033[1;97m          \033[38;5;34m│\033[0m\n"
    "\033[38;5;34m  │\033[1;97m [\033[38;5;226m09\033[1;97m] DNS Reverse    \033[38;5;34m│\033[1;97m [\033[38;5;226m99\033[1;97m] Update FIXTT          \033[38;5;34m│\033[0m\n"
    "\033[38;5;34m  │\033[1;97m [\033[38;5;226m10\033[1;97m] Email Finder   \033[38;5;34m│\033[1;97m [\033[38;5;226m00\033[1;97m] Quit                  \033[38;5;34m│\033[0m\n"
    "\033[38;5;34m  └─────────────────┴───────────────────────────┘\033[0m\n"
)
...
about = """
[38;5;34m  ┌──────────────────────────────────────────────────────┐[0m
[38;5;34m  │[38;5;46m  FIXTT — Advanced OSINT Intelligence Framework       [38;5;34m│[0m
[38;5;34m  ├──────────────────────────────────────────────────────┤[0m
[38;5;34m  │[1;97m  Author   : [38;5;46mkrypthane [38;5;240m· wavegxz-design              [38;5;34m│[0m
[38;5;34m  │[1;97m  GitHub   : [38;5;51mgithub.com/wavegxz-design               [38;5;34m│[0m
[38;5;34m  │[1;97m  Telegram : [38;5;51mt.me/Skrylakk                           [38;5;34m│[0m
[38;5;34m  │[1;97m  Email    : [38;5;51mWorkernova@proton.me                    [38;5;34m│[0m
[38;5;34m  │[1;97m  Location : [38;5;226mMexico 🇲🇽 UTC-6                        [38;5;34m│[0m
[38;5;34m  ├──────────────────────────────────────────────────────┤[0m
[38;5;34m  │[38;5;240m  FIXTT is an advanced OSINT framework that gathers   [38;5;34m│[0m
[38;5;34m  │[38;5;240m  intelligence on IPs, emails, phones, domains,       [38;5;34m│[0m
[38;5;34m  │[38;5;240m  images, dark web and more. Authorized use only.     [38;5;34m│[0m
[38;5;34m  └──────────────────────────────────────────────────────┘[0m
[38;5;240m  "Know the attack to build the defense." — krypthane[0m
"""
def traceip():
	targetip = input("\033[1;91mEnter IP Address: \033[0m")
	r = requests.get("http://ip-api.com/json/" + targetip, timeout=8)
	...
	if mapaddress == "":
		...
		print()
		# FIX: webbrowser.open() — no shell injection risk from external API data
		webbrowser.open(f"https://maps.google.com/?q={r.json()['lat']},{r.json()['lon']}")
		print()
	else:
		print()
		print("[*] Aborting.....")
...
##Payment Support
# FIX [SECURITY]: API key moved to environment variable — never hardcode secrets in source.
# Set STRIPE_API_KEY in your environment before running:
#   export STRIPE_API_KEY="sk_test_..."
import os as _os
stripe.api_key = _os.environ.get("STRIPE_API_KEY", "")
if not stripe.api_key:
    print("\033[1;33m[!] STRIPE_API_KEY not set. Payment support disabled.\033[0m")
...
def email_info():
	...
	ipqs_key = os.environ.get("IPQUALITYSCORE_KEY", "").strip()
	if not ipqs_key:
		print("\033[1;33m[!] IPQUALITYSCORE_KEY not set.\033[0m")
		print("\033[2m    export IPQUALITYSCORE_KEY=\"your_key\"")
		print("    Get free key: https://www.ipqualityscore.com/create-account\033[0m")
		return
	eml = requests.get(f"https://ipqualityscore.com/api/json/email/{ipqs_key}/{mailid}", timeout=10)
...
def update():
	...
	if update_terminal == "1":
		...
		if path.is_file():
			...
			time.sleep(0.9)
			os.system("cd $HOME")
			os.system("git clone https://github.com/wavegxz-design/FIXTT")
			print("\033[1;97m[+] Granting permissions.....\033[0m\n")
			os.system("cd $HOME && cd FIXTT")
			os.system("chmod +x *")
			sleep(0.5)
			...
			sleep(2)
			os.system("cd $HOME ")
			os.system("cd FIXTT && bash setup.sh")
...
if option == "1":
	...
	if os.path.exists("./hunter_io_api.txt") and os.path.getsize("./hunter_io_api.txt") > 0:
		...
		file = open('hunter_io_api.txt', 'w')  # FIX: filename mismatch (.txt was missing)
    ...
    if not os.path.isfile(file_path):
        ...
        if metadata:
            ...
            if specific_metadata.get("Location"):
                ...
                print(f"\n{YELLOW}No geolocation data found. \n{GREEN}Use option 3 from FIXTT menu to retry getting the location if its an image file you attached{RESET}")
        else:
	...
	# FIX [OPT-13]: Original code had self outside class → NameError on run.
	# Replaced with a minimal working threaded subdomain scanner.
	import threading as _thr
	from queue import Queue as _Q
	import socket as _sock

	_domain = input("\033[1;91m[+]\033[0m\033[1;97mEnter domain name (without www): \033[0m").strip()
	_file_path = input("\033[1;91m[+]\033[0m\033[1;97mPath of subdomains list: \033[0m").strip()

	if not os.path.isfile(_file_path):
		print(f"\033[1;91m[!]\033[0m File not found: {_file_path}")
	else:
		_subs = [s.strip() for s in open(_file_path).read().splitlines() if s.strip()]
		_found = []
		_lock  = _thr.Lock()
		_q     = _Q()
		for _s in _subs: _q.put(_s)

		def _probe_sub():
			while True:
				try: _word = _q.get_nowait()
				except: break
				_host = f"{_word}.{_domain}"
				try:
					_sock.gethostbyname(_host)
					with _lock:
						_found.append(_host)
					print(f"\033[1;94m[+]\033[0m Valid Subdomain: {_host}")
				except (_sock.gaierror, _sock.timeout):
					pass
				finally: _q.task_done()

		_threads = [_thr.Thread(target=_probe_sub, daemon=True) for _ in range(min(50,len(_subs)))]
		[t.start() for t in _threads]
		_q.join()
		print(f"\033[1;34m[*]\033[0m Found {len(_found)} subdomain(s) for {_domain}")
#### Google Dorking Hacking 
	...
	try:
		...
		if report == "y":
			try:
				import webbrowser
				webbrowser.open('mailto:?to=Workernova@proton.me&subject=FIXTT-bugs', new=1)
			except ImportError:
...
#### InfoStealer Attack
    ...
    print(ten_main_menu)
    ten_input = input('\033[38;5;208mfixtt>> \033[0m')
...
#### DEEP WEB SCRAPING OSINT
	...
	def service():
		...
		if platform.system() == "Linux":
			# FIX [SECURITY]: shell=True replaced — tor check split into safe list calls
			try:
				status = subprocess.run(['systemctl', 'is-active', 'tor.service'],
					capture_output=True, text=True, timeout=10)
				if 'inactive' in status.stdout or 'failed' in status.stdout:
					print(R + '[!] Tor not running. Start: sudo systemctl start tor' + W)
					return  # FIX: was printing error but continuing anyway
				else:
					print(C + '[+] Tor is active.' + W)
			except (FileNotFoundError, subprocess.TimeoutExpired):
				print(R + '[!] Tor not found. Install with: sudo apt install tor' + W)
	...
	def scrap():
		# FIX: timeout added — was hanging forever
		try:
			page = requests.get("http://icanhazip.com", timeout=10,
				proxies={"http":"socks5h://127.0.0.1:9050","https":"socks5h://127.0.0.1:9050"})
			print(R + '[+]' + G + ' Connected to Tor....')
			print(R + '[->]' + G + 'Your Tor IP → ' + page.text.strip())
		except requests.exceptions.RequestException as _e:
			print(R + f'[!] Could not verify Tor IP: {_e}' + W)
	...
	def main():
		...
		query = input('\033[1;91m[+]\033[0m\033[1;94mEnter keyword to search: \033[0m').strip()
		if not query:
			print(R + "[!] Empty query." + W)
			return
		URL = f"https://ahmia.fi/search/?q={query}"
		# FIX: single request with timeout — was fetching URL twice without timeout
		try:
			request = requests.get(URL, timeout=15)
		except requests.exceptions.RequestException as _e:
			print(R + f'[!] Request failed: {_e}' + W)
			return
		page = request  # alias for soup parsing below
    ...
    second_main_menu = ("""
                     ...
                     \033[1;91m[\033[1;33;40mG\033[0m\033[1;91m] \033[1;97m  Go back
                     \033[1;91m[\033[1;33;40m99\033[0m\033[1;91m] \033[1;97m Quit FIXTT
                     """) ##I would still add more here
    print(second_main_menu)
    second_input = input('\033[38;5;208mfixtt>> \033[0m')
...
##Network Mapper
    if second_input == "29":
        ...
        # FIX: app was renamed to _flask_app — use accessor
        try:
            _get_flask_app().run(host='127.0.0.1', port=8000)  # FIX: 127.0.0.1 not 0.0.0.0
        except Exception as _e:
            print(f"\033[1;91m[!]\033[0m Network mapper error: {_e}")
        sys.exit(1)
        
    
    if second_input == "99":
        #print("\033[1;92mExiting FIXTT Program...\033[0m")
        exit()
...
##DnsInf Action    
    ...
    if second_input == "22":
        ...
        seven_input = input('\033[38;5;208mfixtt>> \033[0m')
        ...
        if c_input == "1":
            ...
            root.title("FIXTT VIN Number Extractor")
...
<footer class="text-center text-lg-start bg-body-tertiary text-muted">
  ...
  <section class="d-flex justify-content-center justify-content-lg-between p-4 border-bottom">
    ...
    <div>
      ...
      <a href="https://google.com/search?q=wavegxz-design" class="me-4 text-reset">
        <i class="fab fa-google"></i>
      </a>
      <a href="https://github.com/wavegxz-design" class="me-4 text-reset">
    ...
    <div class="container text-center text-md-start mt-5">
      ...
      <div class="row mt-3">
        ...
        <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
          ...
          <p>
            Welcome to FIXTT where you can read all changelogs and check out whats new in FIXTT.
          </p>
        </div>
        <!-- Grid column -->
  ...
  <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.05);">
    © 2024 Copyright:
    <a class="text-reset fw-bold" href="https://github.com/wavegxz-design">wavegxz-design</a>
  </div>
  <!-- Copyright -->
</footer>
<!-- Footer -->
...
"""
    ...
    server.listen(port, () => {{
        console.log(`Visit the server below to see whats new in FIXTT`)
...
# ═══════════════════════════════════════════════════════════════════════
# ENTRY POINT v7.4 — all execution guarded here
# ═══════════════════════════════════════════════════════════════════════
if __name__ == "__main__":
    ...
    try:
        ...
        print("\n\033[1;34m[*] Exiting FIXTT.\033[0m")
        sys.exit(0)
